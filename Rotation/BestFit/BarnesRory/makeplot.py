...
plt.subplot(3, 2, 3)
plt.plot(time, out.b.RotPer, color=vplot.colors.red,label='b')
plt.plot(time, out.d.RotPer, color=vplot.colors.orange,label='d')
plt.plot(time, out.c.RotPer, color=vplot.colors.pale_blue,label='c')
plt.xlabel("Time (kyr)")
